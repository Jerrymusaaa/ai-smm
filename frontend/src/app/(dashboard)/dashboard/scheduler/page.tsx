...
const INITIAL_POSTS: ScheduledPost[] = [
  ...
  { id: '6', title: 'Customer spotlight', platform: 'Facebook', platformColor: '#1877F2', platformInitial: 'FB', time: '2:00 PM', date: fmt(addDays(today, 3)), status: 'scheduled', content: 'Meet Sarah, who grew her Instagram by 340% using SocialAI in just 30 days! 🌟', hasMedia: true },
