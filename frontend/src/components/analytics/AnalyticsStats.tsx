...
const STATS = [
  ...
  { label: 'Link clicks', value: '12,847', change: '-412', pct: '-3.1%', trend: 'down', icon: MousePointerClick, color: '#FF6B35',
    sparkline: [80,75,85,78,82,70,75,68,72,65,70,68] },
  { label: 'Shares & reposts', value: '3,291', change: '+962', pct: '+41.3%', trend: 'up', icon: Share2, color: '#F59E0B',
    sparkline: [20,30,25,40,38,55,52,65,70,80,85,95] },
  { label: 'Comments', value: '6,184', change: '+1,024', pct: '+19.8%', trend: 'up', icon: MessageCircle, color: '#EC4899',
    sparkline: [35,45,40,58,55,65,62,75,72,82,80,90] },
];
