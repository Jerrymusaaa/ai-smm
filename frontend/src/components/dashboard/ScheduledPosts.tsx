...
const POSTS = [
  {
    id: 1, platform: 'Instagram', platformColor: '#E1306C', initial: 'IG',
    time: 'Today, 6:00 PM', content: '🌟 Exciting news! Our new product launch is just around the corner. Stay tuned for something amazing...',
    status: 'scheduled', image: true,
  },
  {
    id: 2, platform: 'TikTok', platformColor: '#FF0050', initial: 'TT',
    time: 'Today, 8:00 PM', content: 'POV: When your AI writes better captions than your entire marketing team 😂 #AIMarketing #SocialMedia',
    status: 'scheduled', image: false,
  },
  {
    id: 3, platform: 'LinkedIn', platformColor: '#0A66C2', initial: 'IN',
    time: 'Yesterday, 9:00 AM', content: 'Thrilled to share our Q1 results: 340% increase in engagement, 18K+ new followers, and a 280% campaign ROI lift.',
    status: 'published', image: false,
  },
  {
    id: 4, platform: 'X / Twitter', platformColor: '#1DA1F2', initial: 'X',
    time: 'Tomorrow, 10:00 AM', content: 'The future of social media management is here. AI-powered, conversational, and incredibly fast. 🚀',
    status: 'draft', image: false,
  },
];
