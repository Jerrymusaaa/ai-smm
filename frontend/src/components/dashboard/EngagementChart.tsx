      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
        <div>
          <h3 style={{ fontFamily: 'var(--font-display)' }}
            className="text-base font-bold text-white">Engagement Overview</h3>
          ...
          <div className="hidden sm:flex items-center gap-1.5 mr-2">
            {PLATFORMS.map(p => (
              <button key={p.key}
                ...
                style={activePlatforms.includes(p.key) ? { background: `${p.color}25`, borderColor: `${p.color}40`, color: p.color } : {}}>
