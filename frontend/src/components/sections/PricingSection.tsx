        ...
        <div className="text-center mb-12">
          ...
          <div className="inline-flex items-center gap-4 glass rounded-full px-2 py-2 border border-white/10">
            <button
              ...
              className={`px-5 py-2 rounded-full text-sm font-medium transition-all ${!annual ? 'bg-white/10 text-white' : 'text-white/40'}`}
            >
              Monthly
            </button>
            <button
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {PLANS.map((plan) => (
            ...
            >
              ...
              <Button variant={plan.variant} size="md" className="w-full rounded-xl">
                {plan.cta}
              </Button>
            </div>
          ))}
