        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 style={{ fontFamily: 'var(--font-display)' }}
              ...
              <span style={{ color: '#00D4AA' }}>what to do</span>
            </h2>
            ...
            <div className="flex flex-wrap gap-2">
              {QUICK_PROMPTS.map((p) => (
                <button
                  key={p}
                  onClick={() => setInput(p)}
                  className="px-3 py-1.5 rounded-full text-xs glass border border-white/10 text-white/50 hover:text-white hover:border-[#00D4AA]/30 transition-all"
                >
                  {p}
                </button>
              ))}
