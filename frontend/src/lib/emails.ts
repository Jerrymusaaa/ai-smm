...
<body style="margin:0;padding:0;background-color:#050A14;font-family:'DM Sans',Arial,sans-serif;">
  <table width="100%" cellpadding="0" cellspacing="0" style="background-color:#050A14;padding:40px 20px;">
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background-color:#0D0D0D;border-radius:16px;border:1px solid rgba(255,255,255,0.08);overflow:hidden;max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:32px 40px 24px;border-bottom:1px solid rgba(255,255,255,0.06);">
              <table cellpadding="0" cellspacing="0">
                <tr>
                  <td style="background:linear-gradient(135deg,#C9A84C,#E8C96A);border-radius:10px;width:36px;height:36px;text-align:center;vertical-align:middle;">
                    <span style="color:white;font-size:18px;font-weight:bold;">⚡</span>
                  </td>
                  <td style="padding-left:12px;vertical-align:middle;">
                    <span style="color:#ffffff;font-size:18px;font-weight:700;letter-spacing:-0.3px;">Yoyzie AI<span style="color:#C9A84C;">.</span></span>
                  </td>
                </tr>
              </table>
            </td>
          ...
          <tr>
            <td style="padding:36px 40px;">
              ...
              <table cellpadding="0" cellspacing="0" style="margin:0 0 28px;">
                <tr>
                  <td style="background:#C9A84C;border-radius:12px;box-shadow:0 8px 32px rgba(0,102,255,0.3);">
              ...
              <p style="margin:0 0 24px;word-break:break-all;">
                <a href="${verificationUrl}" style="color:#C9A84C;font-size:13px;text-decoration:none;">${verificationUrl}</a>
              </p>
